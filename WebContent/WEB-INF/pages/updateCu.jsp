    ...
    <table class="tbform">
        ...
        <tbody>
            ...
            <tr>
                <td class="tdl">密码</td>
                <td>
                         <input type="text" name="password" class="ipt" />
                </td>
            </tr>
            <tr>
                <td class="tdl">身份证 </td>
                <td>
                         <input type="text" name="identity" class="ipt" />
                </td>
            </tr>
            <tr>
                <td class="tdl">姓名</td>
                <td>
                    <div class="input-append">
                       <input type="text"  name="fullname" class="ipt" />
                    </div>
                </td>
            </tr>
            <tr>
                <td class="tdl">性别 </td>
                <td>
                         <input type="text" name="sex" class="ipt" />
                </td>
            </tr>
            <tr>
                <td class="tdl">地址</td>
                <td class="detail">
                    <input type="text" name="address" class="ipt" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
             <tr>
                ...
                <td class="detail">
                    <input type="text" name="position" class="ipt" />
                </td>
